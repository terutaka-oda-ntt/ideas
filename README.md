...
- `scripts/apply_branch_protection.sh` の必須チェック名と対象ブランチ
...
後付け導入を半自動化する場合は [scripts/bootstrap_guardrails.sh](scripts/bootstrap_guardrails.sh) を利用できます。
...
[`scripts/bootstrap_guardrails.sh`](scripts/bootstrap_guardrails.sh) を利用します。
